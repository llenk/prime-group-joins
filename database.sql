...
-- 	1. Get all customers and their addresses. (I'm just doing the first line of the address.)
-- I know how to add the rest.
...
AND "products"."description" = 'cheetos';

--	4.	Which warehouses have diet pepsi?
--		The bad ones. Next question.
SELECT "warehouse"."warehouse"
FROM "warehouse_product"
JOIN "warehouse"
ON "warehouse"."id" = "warehouse_product"."warehouse_id"
